...
select e.empno, e.ename, e.deptno, m.empno as manager_no, m.ename as manager_name, m.deptno as manager_deptno
from emp e
join emp m on e.mgr_no = m.empno
where e.deptno = m.deptno;


select e.empno, e.ename, e.deptno, e.sal, i.incentive_date, i.incentive_amount
from emp e
